...
static const uint8_t HX8357D_regValues[] PROGMEM = {
  ...
  TFTLCD_DELAY, 10,  //sebelumnya 250
  ...
  HX8357_SLPOUT, 0,
  TFTLCD_DELAY, 10,  //sebelumnya 150
  HX8357_DISPON, 0, 
  TFTLCD_DELAY, 10,  //sebelumnya 50
};

static const uint16_t ILI932x_regValues[] PROGMEM = {
  ILI932X_START_OSC        , 0x0001, // Start oscillator
  TFTLCD_DELAY             , 10,     // 50 millisecond delay
  ...
  TFTLCD_DELAY             , 10, //sebelumnya 200
